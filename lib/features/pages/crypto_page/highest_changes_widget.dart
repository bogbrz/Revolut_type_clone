...
class HighestChangesWidget extends StatefulWidget {
  const HighestChangesWidget(
      {super.key, required this.sortedList, required this.reversed});
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: () {
                      context.pushRoute(
                          CryptoDetailsRoute(id: choosedSorting[index]!.id!));
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.network(
                            scale: 4, choosedSorting[index]?.image ?? ""),
                        Expanded(
                          child: Text(
                        ...
                        Text(choosedSorting[index]?.currentPrice.toString() ??
                            "Dupa"),
                        Text(
