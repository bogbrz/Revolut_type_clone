...
class DetailPlatforms {
  Map<String?, PlatformDetail?>? platforms;
  ...
  factory DetailPlatforms.fromJson(Map<String, dynamic> json) =>
      DetailPlatforms(
        platforms: json.map((k, v) =>
            MapEntry<String, PlatformDetail>(k, PlatformDetail.fromJson(v))),
      );
}
...
class Platforms {
  ...
  factory Platforms.fromJson(Map<String, dynamic> json) => Platforms(
        platforms: Map.from(json).map((k, v) => MapEntry<String, String>(k, v)),
      );
}
